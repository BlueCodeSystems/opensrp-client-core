...
[![Build for latest tag (v7.0.0)](https://jitpack.io/v/BlueCodeSystems/opensrp-client-core/v7.0.0.svg)](https://jitpack.io/#BlueCodeSystems/opensrp-client-core/v7.0.0)
...
- Default branch: `master`; latest tag: `v7.0.0` (git).
